...
writexml.write_on_xml(xmin, xmax, ymin,ymax,zmin,zmax,nx_elem,ny_elem,nz_elem, box_eps, delta, eps, vti_f)
writexml.writebase(xs, ys, zs, f,cfl_factor, Tmax, dt, vp)

data = geos_json.getData(xmax,xmin,ymax,ymin,zmax,zmin,nx_elem,ny_elem,nz_elem, delta, eps, vti_f,xs,ys,zs, f,cfl_factor, Tmax, dt, ndt, vp,vh,vn)
