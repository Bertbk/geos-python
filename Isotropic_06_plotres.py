...
# get Args
parser = argparse.ArgumentParser(description='Plot results for ISOTROPIC assuming .npy files exist')
...
ax.set_title("GEOS (Isotropic): Wavefield at t="+str(format(time*1000., '.2f'))+"ms")
ax.set_xlabel("X Coordinate (m)")
ax.set_ylabel("Z Coordinate (m)")
ax.grid()
fig.colorbar(pos, ax=ax)

figtitle = "geos-acoustic-xz.png"
