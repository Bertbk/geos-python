...
ax.set_title("Devito: Wavefield at t="+str(format(time, '.2f'))+"ms")
ax.set_xlabel("X Coordinate (m)")
ax.set_ylabel("Z Coordinate (m)")
ax.grid()
fig.colorbar(pos, ax=ax)
figtitle = "devito-density-3D-xz-density.png"
...
ax.grid()
fig.colorbar(pos, ax=ax)
figtitle = "devito-density-3D-xy-density.png"
print("Saving figure as ... " + figtitle)
fig.savefig(figtitle)
print("done")
...
ax.grid()
fig.colorbar(pos, ax=ax)
figtitle = "devito-density-3D-yz-density.png"
print("Saving figure as ... " + figtitle)
fig.savefig(figtitle)
print("done")
